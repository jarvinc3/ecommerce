...
export const Nav = () => {
    ...
    return (
        <div className="fixed pb-5 bg-white transition-all duration-300 z-50 dark:bg-[#242424] top-0 flex items-center justify-between w-full gap-2 px-3 pt-5 -translate-x-1/2 md:pt-8 md:px-10 left-1/2 ">
            <NavBarSearch />
